...
export default function GetApp() {
  ...
  useSeo({
    title: "Get the ALLUR App — Install on iPhone & Android",
    description:
      "Install ALLUR on your phone in seconds. Add the AI fitness coach to your home screen on iOS or Android and start your personalized plan.",
    path: "/get",
  });
