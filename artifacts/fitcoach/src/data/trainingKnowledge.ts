// ALLUR â Training knowledge base.
//
...
// weekly volume, intensity, recovery and consistency â the split is just the
...
// Section 1 â the non-negotiables that apply to every goal.
export const UNIVERSAL_PRINCIPLES = [
  "Specificity â train the exact quality you want to improve.",
  "Progressive overload â gradually add weight, reps, sets, range, or quality.",
  "Volume drives adaptation, but only what you can recover from â about 10â20 hard sets per muscle per week is the growth window for most.",
  "Frequency â train each muscle about 2x per week; it beats the same weekly volume crammed into one session.",
  "Match intensity to the goal: heavy (85%+ 1RM) for strength, moderate loads near failure for muscle.",
  "Proximity to failure matters more for muscle than for strength â most hard sets end 0â3 reps in reserve.",
  "Most people need both lifting and cardio (~150 min/wk + 2+ strength days).",
];

// Section 2 â evidence-based weekly volume model (Jeff Nippard, "How Many Sets
// Do You Need?"). Volume is counted in HARD sets â taken to within 0â3 reps in
...
export interface VolumeLandmark {
  // Minimum effective volume â the floor that still drives/maintains growth.
  mev: string;
  // Recommended growth range â where most progress happens for the effort.
  growth: string;
...
export const VOLUME_GUIDELINES: {
  ...
  byExperience: {
    Beginner: { mev: "1â5 sets/week", growth: "4â12 sets/week", max: null },
    Intermediate: { mev: "4â8 sets/week", growth: "8â15 sets/week", max: null },
    Advanced: { mev: "4â8 sets/week (maintenance)", growth: "12â20 sets/week", max: "15â25 sets/week (specialization)" },
  },
  progression: {
    Beginner: "Start at ~8 hard sets/week per muscle; add sets only when progress stalls.",
    Intermediate: "Operate mostly between 10â15 hard sets/week per muscle.",
    Advanced: "Keep most muscles at 10â15 sets; push lagging muscles to 15â20+ sets temporarily, then bring them back.",
  },
  // The "sweet spot" most lifters get excellent results from without piling on fatigue.
  perMuscleWeeklySets: [
    { muscle: "Chest", sets: "10â20" },
    { muscle: "Back", sets: "14â22" },
    { muscle: "Quads", sets: "12â18" },
    { muscle: "Hamstrings", sets: "10â16" },
    { muscle: "Glutes", sets: "8â16" },
    { muscle: "Shoulders (esp. side delts)", sets: "12â20" },
    { muscle: "Biceps", sets: "12â20" },
    { muscle: "Triceps", sets: "10â16" },
    { muscle: "Calves", sets: "12â16" },
    { muscle: "Abs", sets: "8â16" },
  ],
  intensityRule: "Quality over quantity: every set should be a HARD set, taken to within 0â3 reps in reserve. Six hard sets beat ten easy ones.",
  diminishingReturns: "Volume has diminishing returns â 0â5 sets is a huge gain, 5â10 adds more, 10â20 yields smaller gains for much more fatigue. Add the least volume that still drives progress.",
};
...
const GOAL_SPECS: Record<NonNullable<Goal>, GoalSpec> = {
  "Weight Loss": {
    ...
    repScheme: "10â15 reps, full-body / circuit style, moderate load",
    intensity: "Moderate (RPE 7â8). HIIT 1â2x/week max â it is fatiguing.",
    weeklyVolume: "2â4 lifting sessions + 150â300 min cardio",
    cardio: "Zone 2 cardio 2â5x/week + 7,000â12,000 steps/day. HIIT sparingly.",
    proteinPerKg: 2.2,
    principles: [
      "Preserve lean mass while dieting â resistance training is non-negotiable.",
    ...
    byExperience: {
      Beginner: {
        ...
        days: [
          ...
          { dayName: "Tuesday", title: "Zone 2 Cardio", exercises: [cardio("Incline Walk (Zone 2)", "35 min", "Conversational pace â should feel sustainable.")] },
      ...
      Intermediate: {
        ...
        days: [
          ...
          { dayName: "Saturday", title: "Intervals + Steps", exercises: [cardio("Intervals", "20 min", "1â2 hard sessions/week is plenty."), cardio("Easy Walk", "20 min")] },
        ],
      },
      Advanced: {
  ...
  "Muscle Gain": {
    label: "Muscle Gain",
    philosophy:
      "Hypertrophy is driven by enough hard weekly sets, high-tension exercises, progressive overload and training close to failure â fueled by protein, food and recovery.",
    repScheme: "6â12 reps on compounds, 10â20 on accessories, 0â3 reps in reserve",
    intensity: "Moderate loads (60â80% 1RM) taken close to failure",
    weeklyVolume: "10â20 hard sets per muscle/week, each muscle trained ~2x",
    cardio: "1â3 easy sessions/week for health â not enough to blunt recovery.",
    proteinPerKg: 2.0,
    principles: [
      "10â20 hard sets per muscle per week is the growth window.",
      "Most hard sets should end 0â3 reps from failure.",
    ...
    byExperience: {
      Beginner: {
        ...
        daysPerWeek: 3,
        days: [
          { dayName: "Monday", title: "Full Body â Squat Focus", exercises: [ex("Back Squat", 3, "6-8", "2m", "Add 2.5kg once you hit the top of the range."), ex("Bench Press", 3, "8-10", "90s"), ex("Lat Pulldown", 3, "10-12", "75s"), ex("Plank", 3, "45s", "45s")] },
          { dayName: "Wednesday", title: "Full Body â Press Focus", exercises: [ex("Overhead Press", 3, "6-8", "90s"), ex("Romanian Deadlift", 3, "8-10", "90s"), ex("Incline DB Press", 3, "10-12", "75s"), ex("Seated Row", 3, "10-12", "75s")] },
          { dayName: "Friday", title: "Full Body â Hinge & Pull Focus", exercises: [ex("Deadlift", 3, "5", "2m"), ex("Pull-ups", 3, "8-10", "90s"), ex("Leg Press", 3, "10-12", "75s"), ex("Barbell Curl", 2, "12", "45s")] },
        ],
      },
      Intermediate: {
  ...
  Strength: {
    ...
    repScheme: "1â5 reps on main lifts, 4â8 for strength-size, 6â15 accessories",
    intensity: "Heavy â ~80%+ of 1RM on main lifts",
    weeklyVolume: "Main lifts 1â3x/week, ~2â3 hard sets per exercise",
    cardio: "Optional easy conditioning for recovery and work capacity.",
    proteinPerKg: 2.0,
    principles: [
      "Main, technical lift first while you're fresh.",
      "Rest 2â4 minutes on heavy work to keep performance up.",
    ...
    byExperience: {
      Beginner: {
        ...
        daysPerWeek: 3,
        days: [
          { dayName: "Monday", title: "Squat + Bench + Row", exercises: [ex("Back Squat", 5, "5", "3m", "Leave 1â2 reps in the tank â don't grind."), ex("Bench Press", 5, "5", "3m"), ex("Barbell Row", 3, "6-8", "2m")] },
  ...
  Athleticism: {
    ...
    philosophy:
      "Athletic performance combines strength, power, conditioning, mobility and skill transfer. Train to move better, jump higher and sprint faster â not just to lift heavy in isolation.",
    repScheme: "Power 3â5 explosive reps, strength 4â6, conditioning intervals",
    intensity: "High-velocity power work + heavy strength + interval conditioning",
    weeklyVolume: "3â5 sessions mixing strength, power and conditioning",
    cardio: "Intervals + Zone 2 base for repeatable performance.",
    proteinPerKg: 1.8,
    principles: [
      "Power and heavy lifts go first, while the nervous system is fresh.",
      "Build an aerobic base â most conditioning should stay easy.",
      "Keep hard intervals limited and purposeful (1â2x/week).",
    ],
    byExperience: {
      Beginner: {
        ...
        daysPerWeek: 3,
        days: [
          { dayName: "Monday", title: "Power & Lower Strength", exercises: [ex("Box Jump", 4, "5", "90s", "Reset fully between reps â quality over fatigue."), ex("Back Squat", 4, "5", "2m"), ex("Walking Lunge", 3, "10/leg", "75s")] },
      ...
      Advanced: {
        ...
        daysPerWeek: 5,
        days: [
          { dayName: "Monday", title: "Max Strength â Lower", exercises: [ex("Back Squat", 5, "3", "3m"), ex("Deadlift", 4, "3", "3m"), ex("Nordic Curl", 3, "6", "90s")] },
          ...
          { dayName: "Thursday", title: "Max Strength â Upper", exercises: [ex("Bench Press", 5, "3", "3m"), ex("Weighted Pull-ups", 4, "4", "2m"), ex("Overhead Press", 4, "5", "2m")] },
...
// Target-physique emphasis â a weak-point / aesthetic finisher appended when the
...
const PHYSIQUE_EMPHASIS: Record<Exclude<TargetPhysique, "">, { day: Workout; note: string }> = {
  ...
  LeanVTaper: {
    note: "Lean V-taper â shoulder and back width plus lean conditioning for a tapered, broad-to-narrow look.",
    day: {
      dayName: "Sunday",
      title: "Width & Taper",
      exercises: [
  ...
  Athletic: {
    note: "Athletic build â explosive, functional work to stay lean and sport-ready.",
    day: {
      dayName: "Sunday",
  ...
  Aesthetic: {
    note: "Aesthetic physique â extra side-delt, upper-chest and arm volume for symmetry, detail and visible abs.",
    day: {
      dayName: "Sunday",
  ...
  Mass: {
    note: "Mass build â heavy compound finisher to drive total-body size and raw strength.",
    day: {
      dayName: "Sunday",
      title: "Mass Builder",
      exercises: [
  ...
  LeanToned: {
    note: "Lean & toned â full-body toning with core and conditioning to stay defined without bulk.",
    day: {
      dayName: "Sunday",
      ...
      exercises: [
        ...
        ex("Incline Walk (Zone 2)", 1, "20m", "â", "Steady conditioning to stay lean."),
      ],
    },
  },
  StrongCurves: {
    note: "Strong curves â glute and leg emphasis for shape and strength while staying athletic.",
    day: {
      dayName: "Sunday",
      title: "Glutes & Curves",
      exercises: [
  ...
  Sculpted: {
    note: "Sculpted physique â shoulders, glutes, legs and abs for an aesthetic, symmetrical, stage-style look.",
    day: {
      dayName: "Sunday",
...
export function buildProgram(profile: UserProfile, goal: Goal): GeneratedProgram {
  ...
  const meta: ProgramMeta = {
    ...
    proteinNote: proteinTargetG
      ? `${spec.proteinPerKg} g/kg â ${proteinTargetG} g/day`
      : `${spec.proteinPerKg} g/kg of bodyweight`,
    emphasis: emphasis ? emphasis.note : null,
    principles: spec.principles,
  };

  // Correctness guard: the label and stated frequency must match the real number
    // of training days. An emphasis day (added above) can push the day count past the
    // base variant, which previously left splitName saying e.g. "5-Day" on 6 workouts.
    const reconciledDays = days.length;
    const reconciledSplitName = meta.splitName.replace(/^\s*\d+\s*-?\s*[Dd]ay\b/, reconciledDays + "-Day");
    return { meta: { ...meta, daysPerWeek: reconciledDays, splitName: reconciledSplitName }, days };
}
